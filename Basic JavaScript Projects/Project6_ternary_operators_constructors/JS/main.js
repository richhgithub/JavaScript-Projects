...
function Vote_Function()    {
    ...
    Can_vote = (Age < 18) ? "You are not old enough to vote.":"You can vote!";  //ternary syntax
    document.getElementById("Vote").innerHTML = Can_vote;
}

function Vehicle(Make, Model, Year, Color)  {   //step 133 and the Class and new keyword and this
    this.Vehicle_Make = Make;   //properties
    this.Vehicle_Model = Model;
    this.Vehicle_Year = Year;
    this.Vehicle_Color = Color;
}
var Jack = new Vehicle("Dodge", "Viper", 2020, "Red");  //instances
